...
| [Records-Spec.md](Records-Spec.md) | durable record 검색·compact 발견, verification, memo/topic/host-fact write/import 계약 | Records 외부·저장 계약이 바뀔 때 |
...
| [releases/v1.0.3.md](releases/v1.0.3.md) | durable record 검색·compact discovery 패치 릴리스 노트 | v1.0.3 사실관계를 수정할 때 |
| [releases/v1.1.0.md](releases/v1.1.0.md) | host facts, memo topics, nested repository 지원과 자동 릴리스 노트 | v1.1.0 사실관계를 수정할 때 |
| [releases/v1.1.1.md](releases/v1.1.1.md) | Go 임시 경로 진단 구분과 lazy toolbox 설계 문서 패치 릴리스 노트 | v1.1.1 사실관계를 수정할 때 |
